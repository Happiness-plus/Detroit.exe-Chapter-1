...
init -1 python hide:
    ...
    config.window_title = u"The Legend"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "The Legend"
    config.version = "0.0"
    ...
    style.window.left_padding = 270
    style.window.right_padding = 270
    ...
    style.default.text_align = 0.5
    style.say_vbox.xalign = 0.5
    style.say_label.xalign = 0.5
    style.who_vbox.xalign = 0.5
    style.who_label.xalign = 0.5
    style.default.outlines = [(1, "#39637F", 0, 0)]
...
#listen to version 1 and 2 again after voicing 
    config.main_menu_music = "Mainv2.ogg"
    config.game_menu_music = "My_beat.ogg"
...
python early:
    config.save_directory = "The Legend-1474049219"
...
init python:
    ...
    build.directory_name = "The_Legend-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "The_Legend"
